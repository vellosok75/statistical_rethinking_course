...
Given the posterior distribution, how can we make predictions? Well, could choose a particular value of $p$, maybe the mode, the peak of the distribution, the most probable value, and use to make predictions about water and land observations with the aid of the likelihood function. But how do we incorporate the uncertainty in $p$ in our estimates? How do we propagate the associated error of choosing a particular value and then doing a prediction? 